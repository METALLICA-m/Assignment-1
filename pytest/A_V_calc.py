...
if __name__ == "__main__":
    ...
    while True:
        ...
        if q == "q": 
            exit("Thank you for using A_V Calculator")
        ...
        while True: # start of the second loop
            ...
            if choice == '1':
                ...
                h = float(input("Enter the Height: "))
                result = cuboid_cal(length, width, height)
                ...
                h = float(input("Enter the Base Height: "))
                H = float(input("Enter the Height: "))
